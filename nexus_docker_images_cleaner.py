...
class NexusCleaner:
    ...
    def __init__(self):
        self.ChkKeep_fl = 0
        self.ChkDays_fl = 0
        self.NEXUS_ADDRESS = 'http://localhost'  
        self.NEXUS_PORT = 8081
        self.NEXUS_USER_LOGIN = 'admin'
        self.NEXUS_USER_PASSWORD = 'admin'
    ...
    def _check_nexus_images(self, RepoName='', ImageName='', ImageVersion=''):
        ...
        search_url = 'http://localhost:8081/service/rest/v1/search'.format(
            self.NEXUS_ADDRESS,
            self.NEXUS_PORT)
    ...
    def _get_all_image_names(self, RepoName=''):
        ...
        search_url = 'http://localhost:8081/service/rest/v1/search'.format(self.NEXUS_ADDRESS, self.NEXUS_PORT)
        print(search_url)
